    ...
    <section class="content-header ">
        <div class="container mx-auto">
            <div class="flex items-center gap-3 py-3 px-4  rounded-tr-lg rounded-tl-lg bg-[#00969B]">
                ...
                <h1 class="breadcrumb-item text-sm text-white text-center  font-bold">Cash Receipt Voucher</h1>
            </div>
        </div>
    </section>
                            ...
                            <div class="card-body table-responsive">
                                    ...
                                    <div class="col-span-3">
                                        <div class="form-group">
                                            @if ($errors->has('data.voucher_date'))
                                                <label
                                                    class="col-form-label label block text-xs font-medium text-[#4B465C] mb-1.5"
                                                    for="inputError">
                                            ...
                                            @else
                                                <label
                                                    class="col-form-label col-form-label label block text-xs font-medium text-[#4B465C] mb-1.5"
                                ...
                                <div class="grid grid-cols-2  gap-2 p-4 pb-2">
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            <label for="class"
                                                class="label block text-xs font-medium text-[#4B465C] mb-1.5">Credit
                                                Account Head</label>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover text-nowrap w-full">
                                                ...
                                                <tbody>
                                                    @foreach ($credit_amounts as $key => $credit_amount)
                                                        <tr
                                                            ...
                                                            <td class="text-start p-4  py-3 text-[#dc3545]"><i
                                                                    wire:click="deleteRecord({{ $key }})"
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th
                                                            class="text-start text-[#005974] p-4 py-3  font-semibold text-xs border border-l border-r-0">
                                                        </th>
                                                        <th
                                                            class="text-[#4B465C] text-start p-4 py-3 font-bold text-xs  border border-l-0">
                                                            Total</th>
                                ...
                                <div class="col-span-6">
                                    <div class="form-group">
                                        <label
                                            ...
                                            for="class">Debit Account Head</label>
                                        <div class="custom-select" wire:ignore>
                                            <select wire:model="data.account_from" 
                                                id="custom-select"
                                                class="js-example-basic-single w-full parttakeAccount">
                                                <option value="0" selected>Select a Credit Account</option>
                                                @foreach ($accounts as $item)
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover text-nowrap w-full">
                                            ...
                                            <tbody>
                                                ...
                                                <tr
                                                    class="text-start p-4  py-3 font-semibold text-xs text-[#005974] border">
                                                    @php $chart_of_account =
                                                    App\Models\Account\ChartOfAccount::where('id',
                                                    $credit_amount['account_to'])->first(); @endphp
                                                    <td
                                                        class="text-start p-4  py-3 font-semibold text-xs text-[#005974] border">
                                                        {{ $chart_of_account->title ?? '' }}
                                                        25{{ $chart_of_account->account_number ?? '' }}
                                                    ...
                                                    <td class="">
                                                        <div
                                                            ...
                                                            <button
                                                                class="read-more-button text-blue-500 text-xs whitespace-nowrap "
                                                                onclick="showMore(this)">See More</button>
                                                            <button class="read-less-button text-blue-500  hidden"
                                                                onclick="showLess(this)">See Less</button>
                                                        </div>
                                                    </td>
                                                    <td
